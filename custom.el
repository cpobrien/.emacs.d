(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (gruvbox-theme alect-themes bongo use-package exec-path-from-shell railscasts-theme telephone-line evil-org wanderlust solarized-theme inf-ruby auto-complete restart-emacs moe-theme nyan-mode magit dashboard resize-window fill-column-indicator clevercss idea-darkula-theme github-modern-theme linum-relative jsx-mode rainbow-delimiters zenburn-theme ccc bury-successful-compilation projectile colemak-evil zenburn counsel swiper ivy per-buffer-theme evil load-theme-buffer-local atom-one-dark-theme color-theme-buffer-local autodisass-java-bytecode json-mode org markdown-mode base16-theme)))
